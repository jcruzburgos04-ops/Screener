    ...
    const dom=new JSDOM(html,{runScripts:'dangerously',pretendToBeVisual:true,
      ...
      beforeParse(w){
        ...
        w.fetch=async(u)=>{
          ...
          // data912 y CNBC los prueba vivo.js; aca contarian como pedidos a Yahoo
          // y la cuenta pasaria a depender de si Nueva York esta abierto al correr
          if(s.indexOf('data912.com')>=0||s.indexOf('cnbc.com')>=0)throw new TypeError('Failed to fetch');
